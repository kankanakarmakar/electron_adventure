...
import { Zap, Monitor, SlidersHorizontal, ArrowLeft } from 'lucide-react';
            ...
            <div className="relative z-10 text-center space-y-12 max-w-4xl px-6">
                <div className="space-y-4">
                    ...
                    <p className="text-xl text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
                        Dual-screen interactive simulation. Launch the <span className="text-blue-400">Circuit View</span> on your main display and control it remotely via the <span className="text-orange-400">Control Panel</span>.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-2xl mx-auto">
                    ...
                    >
                        ...
                        <div className="relative flex flex-col items-center gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-slate-400 text-sm">Visualize the electron flow and real-time updates on a large canvas.</p>
                            </div>
                            <button className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl py-3 transition-colors">
                                Launch Display
                            </button>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        className="group relative bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-slate-800/80 transition-all cursor-pointer hover:border-orange-500/50 hover:scale-105 active:scale-95 duration-300 shadow-2xl"
                    >
                        <div className="absolute inset-0 bg-orange-500/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <div className="relative flex flex-col items-center gap-6">
                            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center shadow-lg shadow-orange-500/30 group-hover:-rotate-12 transition-transform">
                                <SlidersHorizontal className="w-10 h-10 text-white" />
                            </div>
                            <div className="space-y-2">
                                <h2 className="text-2xl font-bold text-white">Controls</h2>
                                <p className="text-slate-400 text-sm">Adjust voltage and resistance values, and switch simulation modes.</p>
                            </div>
                            <button className="w-full bg-orange-600 hover:bg-orange-500 text-white font-bold rounded-xl py-3 transition-colors">
                                Launch Controls
                            </button>
                        </div>
                    </div>
